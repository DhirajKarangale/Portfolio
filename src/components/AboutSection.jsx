...
export const AboutSection = () => {
  ...
  const features = [
    "📚 Learns continuously by building and breaking things",
    "🔍 Prefers understanding a problem deeply before solving it",
    "🛠 Designs systems that hold up under real traffic",
    "🐛 Enjoys debugging the kind of bugs logs don't explain",
    "📦 Cares about deployment, monitoring, and failures",
    "⚙️ Ships code other engineers won't hate maintaining",
  ...
  const handleDownload = () => {
    ...
    link.href = 'https://github.com/DhirajKarangale/Resume/raw/main/DhirajKarangale.pdf';
    link.download = 'DhirajKarangale.pdf';
            ...
            <div className="bg-card/60 border border-border rounded-3xl p-4 sm:p-6 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:shadow-3xl hover:border-primary/40 hover:bg-card-70">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0 mb-2 sm:mb-3">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="font-semibold text-xs sm:text-sm">Open to Opportunities</span>
                </div>
