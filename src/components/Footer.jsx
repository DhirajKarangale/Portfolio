...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/dhiraj-karangale-464ab91bb/", label: "LinkedIn" },
    { icon: <Code2 size={18} />, href: "https://leetcode.com/u/DhirajKarangale/", label: "Leetcode" },
    { icon: <Github size={18} />, href: "https://github.com/DhirajKarangale", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "dakarangale02@gmail.com", href: "mailto:dakarangale02@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 7620320595", href: "tel:+917620320595" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">DK</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Full-Stack Engineer building reliable systems with real-world use
              </p>
          ...
          >
            <div>
              <p className="flex items-center gap-1"><Copyright size={14} /> {currentYear} DK. All rights reserved.</p>
            </div>
